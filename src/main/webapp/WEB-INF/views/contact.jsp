			...
			<div class="header-right">
				...
				<div class="head-nav">
					...
					<ul class="cl-effect-15">
						...
						<li class="active"><a href="http://localhost:8080/gym/contact" data-hover="CONTACT">CONTACT</a></li>
						<div class="clearfix"> </div>
					</ul>
				</div>
